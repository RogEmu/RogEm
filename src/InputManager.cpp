...
static const std::unordered_map<int, PadButton> defaultKeys = {
    ...
    { GLFW_KEY_W,     PadButton::PAD_TRIANGLE},
    { GLFW_KEY_A,     PadButton::PAD_SQUARE },
    { GLFW_KEY_S,     PadButton::PAD_CROSS },
    { GLFW_KEY_D,     PadButton::PAD_CIRCLE },
    { GLFW_KEY_Q,     PadButton::PAD_L1 },
    { GLFW_KEY_E,     PadButton::PAD_R1 },
    { GLFW_KEY_1,     PadButton::PAD_L2 },
    { GLFW_KEY_3,     PadButton::PAD_R2 },
